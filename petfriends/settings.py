...
# Django settings for petfriends project.
import os
...
DATABASES = {'default': dj_database_url.config(default='postgres://localhost/petfriends')}
...
SECRET_KEY = 'qxp7-)_l7v)nt()os#f81eb9mdl4^rk^=qu%y=q4%#k2scw!3e'
...
ROOT_URLCONF = 'petfriends.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'petfriends.wsgi.application'
